...
import { Loader2, Copy, Share2, Users, Zap } from "lucide-react";
        ...
        <div className="px-4 pt-3 pb-8">
          ...
          <div className="flex gap-2 mb-4">
            ...
            <button
              onClick={handleCopy}
              disabled={!referralLink}
              className="h-11 px-4 rounded-xl font-bold text-sm flex items-center justify-center gap-1.5 transition-all active:scale-[0.97] disabled:opacity-40"
              style={{
                background: "#111",
                border: `1px solid ${copied ? ACCENT + "40" : "#222"}`,
          ...
          {isLoading ? (
            ...
            <div
              className="rounded-xl py-5 flex flex-col items-center gap-1 text-center"
